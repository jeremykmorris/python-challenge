Xpert Leaning Assistant was used to finalize the last section of code in both of the main.py files so that textfile of the results would be sent to the correct folder.
